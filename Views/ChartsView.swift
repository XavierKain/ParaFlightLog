    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 16) {
            ...
            VStack(alignment: .leading, spacing: 4) {
                ...
                Text("\(spotData.count) spot\(spotData.count > 1 ? "s" : "") différent\(spotData.count > 1 ? "s" : "")")
                    .font(.subheadline)
                    .foregroundStyle(.secondary)
            }
            .padding(.horizontal)
            ...
            if spotData.isEmpty {
                ...
                VStack(spacing: 12) {
                    ...
                    if spotData.count > 10 {
                        Text("+ \(spotData.count - 10) autre\(spotData.count - 10 > 1 ? "s" : "") spot\(spotData.count - 10 > 1 ? "s" : "")")
                            .font(.caption)
                            .foregroundStyle(.secondary)
                            .padding(.top, 4)
                    }
